...
- A 120-second synthetic exploratory run completed over 2,300 observations and
  240 thoughts, then landed and disarmed. RTP fixtures and rendered Gazebo
  camera runs also verify the video, Mac, CM5, and PX4 paths.
